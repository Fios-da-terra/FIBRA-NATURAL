...
| 5 | **Instagram confere?** | ⚠️ verificar | Está `@naturaven.oroymd`. Se o perfil for outro, corrija no `config.js`. |
...
| 13 | **Link na bio do Instagram** | O site só existe se alguém chegar nele. |
